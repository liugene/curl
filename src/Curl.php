 ...
 * $curl = new CUrl(2);
 * // GET
 * $rs = $curl->get('https://linkphp.cn/Public/demo/?service=Default.Index');
 * // POST
 * $data = array('username' => 'liugene');
 * $rs = $curl->post('https://linkphp.cn/Public/demo/?service=Default.Index', $data);
 */
